...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    title: `${moc.title} — Warren Buffett · Investor Minds`,
    ...
    <div className="min-h-screen">
      <header className="border-b border-stone-200 bg-white px-6 py-8">
        <div className="mx-auto max-w-3xl">
          ...
          <span className="mb-2 inline-block rounded-full bg-amber-100 px-2.5 py-0.5 text-xs font-medium text-amber-700">
            Map of Content
          </span>
